...
//         var smcID = smcIDRef.current.value;
...
//         var studyGroup = studyGroupRef.current.value;
...
//         var officialName = (session.user.name).replace(/ /g, '').toUpperCase();
//         var signedName = signature.replace(/ /g, '').toUpperCase();
//         if (officialName !== signedName) {
//             setSignatureWarning(`Your signature must excactly match your official full name: ${session.user.name}`); return;
//         } else {
//             setSignatureWarning(``);
//         }

//         const formData = { smcID, name, country, city, zipCode, phone, email, major, studyGroup, signature, preferredName, ...state };
//         const baseUrl = process.env.NEXT_PUBLIC_ORIGIN_RUL
//         const fileUploadResponse = await fetch(`${baseUrl}/api/form/uploadconfirm`, {
//             method: 'POST',
//             mode: 'cors',
//             cache: 'no-cache',
...
//             },
//             body: JSON.stringify({ code: fileUploadCode })
//         });

//         if (fileUploadResponse.status !== 200) {
//             setFileUploadWarning("Your file upload confirmation code did not match. You will receive an upload confirmation code after submitting this Google form: <a href='https://forms.gle/PusZWSvqNGYtuDHc8 '>https://forms.gle/PusZWSvqNGYtuDHc8 </a>")
//             return;
//         } else {
//             const submitResponse = await fetch(`${baseUrl}/api/form/submit`, {
//                 method: 'POST',
//                 mode: 'cors',
//                 cache: 'no-cache',
//                 credentials: 'same-origin',
...
//                     <input ref={nameRef} type='text' id='fname' name='fname' value={session.user.name} disabled></input><br />
//                 </div>
//                 <div className={styles.textField}>
...
//         return { name: "permanentMember", title: "Are you an AGS permanent member?", values: ["Yes", "No"] }
//     }
...
// //action.payload
// /*
// 1. setup api/form/submit.
// 2. create DDB table ags_signup_form.
